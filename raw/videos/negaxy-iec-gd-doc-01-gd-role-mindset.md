...
- **Damage tiềm năng cao nhất trong team** — Giang note: *"Các bạn art hay dev nếu làm sai thì chỉ một mình các bạn đi làm lại. Nhưng GD làm sai thì tất cả các bộ phận khác phải đi hầu lại, đi sửa lại."*
- **Tuyển vào rất nhạy cảm** → tuyển nhầm thiệt hại lan.
...
Lập luận của Vũ:
- Người **nghĩ ra** function là người hiểu sâu nhất. Bộ phận khác có thể làm, nhưng không thể tốt bằng.
- Chỉ một vài role đặc thù (script writer, environment artist) tách riêng được vì *"công việc của ông ấy chỉ có biết chuyện thôi"*.
- Còn lại — concept, function, balance — *"đâu liên quan gì việc không làm? Tắc anh em cũng thỏa mãn hết rồi."*

Khuyên trực tiếp cho Giang: *"Bạn GD đấy hiểu sai vai trò rồi, bạn đó đuổi."*
...
Anti-pattern Hiệp warn: *"Đừng giải quyết bài toán 'tôi làm xong thì mất trend'. Hãy tránh không rơi vào luồng suy nghĩ đó từ đầu — cộng trừ nhân chia các vị trí, chúng ta đừng có sáo trộn cố tình tạo ra nó thành câu cao lên nhưng không gãy nhẹn."*
...
Bài học: phải biết **trend mang lại gì** (CPI thấp, FPV giữ) và **user mang lại gì** (LTV qua tương tác in-app) — tách rạch ròi 2 đầu. Khi trend tắt, CPI tăng → phải tăng LTV bù lại bằng kéo dài core loop. Ví dụ Im Control: hyper → hybrid bằng cách *"thay vì core loop từ 1 đến 2, người ta làm 1 → 1.5 → 1.8 → 1.9 → 2"* — kéo lifetime dài qua việc đi đường vòng nhưng vẫn satisfying.
...
### Level 0 — "Anh em lấy game puzzle đi"
...
### Level 1 — Mô Tả Như User

Mô tả game có *"đánh nhau, có đi phụ bản, cầm cung cầm súng cầm dao"* — *"rất là sơ khai"*. CV / Ether Refresher đầy kiểu này. Không hiệu quả.
...
*"Cái dấu tố ẩn là các cái chip bên trong — các tỷ lệ chip bên trong. Phần level design lúc trước rất là dễ hoặc rất là khó. Nhưng chỉ cần bạn mua 1 cái booster thôi, tương ứng level bạn twit sang 1 cái data ẩn rồi sao đó dễ hơn — user sẽ dễ chịu hơn."*
...
1. **Sếp đang quan tâm dòng nào** — ấn tượng cá nhân. *"Khi mà mình thuyết phục anh Huy thì anh Huy thích — chính thôi."* Hoặc *"em nghe bảo anh Thơ ở bên Xuân Hát làm một Match Bar thành công lắm"* → thuyết phục dễ hơn.
...
Output từ con game ─→ LTV (lifetime value)
                   ...
                   └─ Investment (số inter / time)

Điều kiện bán dự án: LTV > CPI
```

### Tính Investment Từ Session
...
Tổng investment đến D4 = 10 + 4 + 3 + 2 + 1 = 20 ads/user
```
...
Hiệp tiet lộ Doc 5-6 sẽ có *"chuyển mô hình từ một con IAA sang một con hybrid, mà chuyển từ một con hybrid sang một con IAA thuật."*
